...
vim.api.nvim_create_user_command("GHReviewNextFile", function()
...
vim.api.nvim_create_user_command("GHReviewCurrentFile", function()
  require("gh_review").open_current_file()
end, { nargs = 0 })
